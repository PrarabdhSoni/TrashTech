...
const AllBookings = ()=>{
    ...
    return(
            <div className="allbookings-container">
              <h1 className="allbookings-heading">Booking Details</h1>
              <table className="allbookings-table">
                ...
                <div className="allbookings-back-button-container">
                    <button className="allbookings-back-button"  onClick={Handle}>Go Back</button>
                </div>
            </div>
    )
}
